            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" id="link" name="link" class="form-control" placeholder="https://xxx"
                           value="{{ old('link') }}" {{ $errors->has('link') ? ' autofocus' : '' }} required>
                    @if ($errors->has('link'))
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" id="goa" name="goa" class="form-control" placeholder=""
                           value="{{ old('goa') }}" {{ $errors->has('goa') ? ' autofocus' : '' }} required>
                    @if ($errors->has('goa'))
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" id="region" name="region" class="form-control" placeholder=""
                           value="{{ old('region') }}" {{ $errors->has('region') ? ' autofocus' : '' }} required>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" id="country" name="country" class="form-control" placeholder=""
                           value="{{ old('country') }}" {{ $errors->has('country') ? ' autofocus' : '' }} required>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" id="url" name="url" class="form-control" placeholder=""
                           value="{{ old('url') }}" {{ $errors->has('url') ? ' autofocus' : '' }} required>
                    @if ($errors->has('url'))
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" id="contact" name="contact" class="form-control" placeholder=""
                           value="{{ old('contact') }}" {{ $errors->has('contact') ? ' autofocus' : '' }} required>
